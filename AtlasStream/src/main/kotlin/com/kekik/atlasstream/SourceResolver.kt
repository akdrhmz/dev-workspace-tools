...
object SourceResolver {
    private const val TAG = "WB_Resolver"
        ...
        listOf(
            ...
            com.kekik.atlasstream.providers.hdfilmcehennemi2.HDFilmCehennemi2(),
            ...
            com.kekik.atlasstream.providers.dizipaloriginal.DiziPalOriginal(),
    ...
    suspend fun resolveLinks(
        ...
        if (media.isMovie) {
            ...
            if (isProviderEnabled("CizgiMax")) {
                jobs += async { resolveCizgiMax(cleanTr, cleanOrig, media.isMovie, media.seasonNumber, media.episodeNumber, subtitleCallback, callback) }
            }
